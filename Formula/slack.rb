class Slack < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/slack/arm64_sonoma/20260424-4aea2b3.bottle.tar.gz"
      sha256 "356f8599ed98034f75404712e11f9bef5d8d199ea42155747a4e0340d6d8d4ac"
    end
    on_intel do
