class GitMono < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/git-mono-20260415-1d4ee03.arm64_sonoma.bottle.tar.gz"
      sha256 "6a5c369f4d3571be97c7865d2ad39fabe87a6e29d41b6f67e2c10330e65b1d62"
    end
    on_intel do
