class GitMono < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/git-mono-20260211.arm64_sonoma.bottle.tar.gz"
      sha256 "2811e188a8a14743bac1e054df1bae6e4dcc21d20156e4191da36767cc757318"
    end
    on_intel do
