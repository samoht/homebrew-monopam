class GitMono < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/git-mono-20260207.arm64_sonoma.bottle.tar.gz"
      sha256 "e27edc0b522ec8efe3c8f8a2065cd94847e0a8b95314b6a9a5ed1d72a1a10c0f"
    end
    on_intel do
