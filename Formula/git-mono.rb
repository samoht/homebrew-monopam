class GitMono < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/git-mono-20260206.arm64_sonoma.bottle.tar.gz"
      sha256 "967b891ed5301654496cebdc321bae78bedebf91199a980c23386a4b48f9baa6"
    end
    on_intel do
