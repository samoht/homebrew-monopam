class Merlint < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/merlint-20260415-259056f.arm64_sonoma.bottle.tar.gz"
      sha256 "4da8ccbd6ec6230a718d9a0ff933d09392c7f51003b51920dfb5b567a9d83f60"
    end
    on_intel do
