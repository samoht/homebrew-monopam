class Merlint < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/merlint/arm64_sonoma/20260514-8242967.bottle.tar.gz"
      sha256 "13fb1fbf5c5a18f4c8b86afcabaf78c29d74a66c8195526481a861c7a85b4469"
    end
    on_intel do
