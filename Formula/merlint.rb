class Merlint < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/merlint-20260326.arm64_sonoma.bottle.tar.gz"
      sha256 "9ac5c208b4fb747f12550e4a3218550df98a7cc4d0dd9a57925ba271a3c20088"
    end
    on_intel do
