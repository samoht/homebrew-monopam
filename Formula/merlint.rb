class Merlint < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/merlint/arm64_sonoma/20260421-01cf29f.bottle.tar.gz"
      sha256 "bfa6848f90da7db33041cf10844264d2d578ceb77bb23fcef5df09d5381a899f"
    end
    on_intel do
