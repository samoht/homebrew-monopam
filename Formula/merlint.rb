class Merlint < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/merlint-20260206.arm64_sonoma.bottle.tar.gz"
      sha256 "4cfe1c7f730b11c7a3005459879c66c6f8a1aae10589556452c51b317f4ac043"
    end
    on_intel do
