class Merlint < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/merlint/arm64_sonoma/20260513-bdba8ba.bottle.tar.gz"
      sha256 "e62149c71d4b4c0aee48a33094388c9e505c8f56238b200adff700221218788e"
    end
    on_intel do
