class Dupfind < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/dupfind/arm64_sonoma/20260511-4f8f444.bottle.tar.gz"
      sha256 "2cfef656a2ddd2f81dbf38f803ef01dc5edbf4a9d4378fb25348caad9bce8dc4"
    end
    on_intel do
