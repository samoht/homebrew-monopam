class Dupfind < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/dupfind-20260310.arm64_sonoma.bottle.tar.gz"
      sha256 "95d6a2d3f509badc6fb45649ccd3f21ee724d691a678291cb3632bb222a90be2"
    end
    on_intel do
