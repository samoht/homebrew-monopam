class Dupfind < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/dupfind/arm64_sonoma/20260424-4aea2b3.bottle.tar.gz"
      sha256 "a12ee3f5e4d6d3b04e25c299a07dacef55cd3f739b5ffc122161f5379f117e65"
    end
    on_intel do
