class Dupfind < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/dupfind/arm64_sonoma/20260512-f3d4277.bottle.tar.gz"
      sha256 "5644f85ff7ac1473ba8e3f5c20e34841d07d4508b9d5b961ab970274aaa04c78"
    end
    on_intel do
