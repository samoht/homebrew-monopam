class Dupfind < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/dupfind/arm64_sonoma/20260513-3e00f1a.bottle.tar.gz"
      sha256 "746d3953adcb4723f6e06785caa7552be497d44196b984cc630fbf39df4b51c8"
    end
    on_intel do
