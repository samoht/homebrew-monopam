class Uniboot < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/uniboot-20260211.arm64_sonoma.bottle.tar.gz"
      sha256 "9e30a79fddb4bc0c8cb4bd828f2397ec487c75be6d2df43a87fc4a1e0cbc2ead"
    end
    on_intel do
