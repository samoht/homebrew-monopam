class Uniboot < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/uniboot-20260415-1d4ee03.arm64_sonoma.bottle.tar.gz"
      sha256 "4fadd1c577c265071d3fb667f07f061da61fcd930cbc7c3df06b56335322995a"
    end
    on_intel do
