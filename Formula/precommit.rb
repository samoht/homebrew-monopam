class Precommit < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/precommit-20260218.arm64_sonoma.bottle.tar.gz"
      sha256 "721a4c8acf16134c320e7ffd5df69160853330f7d6fb91b6f5fdf39212fe2b4d"
    end
    on_intel do
