class Meross < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/meross/arm64_sonoma/20260424-4aea2b3.bottle.tar.gz"
      sha256 "8bd064354a77b0df17428ada28d55733cae646b6fe3ece537396a23d95ed08ff"
    end
    on_intel do
