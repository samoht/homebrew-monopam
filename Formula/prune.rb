class Prune < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/prune/arm64_sonoma/20260424-4aea2b3.bottle.tar.gz"
      sha256 "10d44fa1b64600c392ef9829aed592b28047f1ce1bec02e102f9533e5b7d10eb"
    end
    on_intel do
