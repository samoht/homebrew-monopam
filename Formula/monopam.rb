class Monopam < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/monopam-20260207.arm64_sonoma.bottle.tar.gz"
      sha256 "7afeb1c037a4a6ebea1c523fdb146ae340af0753de5a254cfb8a5a4470f372dd"
    end
    on_intel do
