class Monopam < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/monopam/arm64_sonoma/20260424-4aea2b3.bottle.tar.gz"
      sha256 "cad32c05e572ea22862f856ac5a3469b8f1d989626cd142faf16692152b0418c"
    end
    on_intel do
