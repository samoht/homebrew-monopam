class Monopam < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/monopam/arm64_sonoma/20260513-3e00f1a.bottle.tar.gz"
      sha256 "d50bff999dc0922125ed172a7d983caa0d377f6f34b5d6a585e6fb609b2b942f"
    end
    on_intel do
