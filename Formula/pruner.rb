class Pruner < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/pruner-20260211.arm64_sonoma.bottle.tar.gz"
      sha256 "a8d416d2bee72bda9ddb667920164663dfc95b7aed2099aa45dbdf0f637944ec"
    end
    on_intel do
