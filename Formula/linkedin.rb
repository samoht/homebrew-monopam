class Linkedin < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/linkedin-20260415-1d4ee03.arm64_sonoma.bottle.tar.gz"
      sha256 "aef1532128c20e56814091636d01b8bf33541466a9aaf21f19b3276e8643c875"
    end
    on_intel do
