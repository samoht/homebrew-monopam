class GitX < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/git-x/arm64_sonoma/20260513-3e00f1a.bottle.tar.gz"
      sha256 "e6411099ecb2fb1e50a3a8baabb5253410ba9c32c383a279c58dc7fff3b9f300"
    end
    on_intel do
