class Bottler < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/bottler-20260204.arm64_sonoma.bottle.tar.gz"
      sha256 "538b60181e824e3776863c3fc4afc3a7ae7a35639c58be63bb760bbe28726c7f"
    end
    on_intel do
