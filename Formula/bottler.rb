class Bottler < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/bottler/arm64_sonoma/20260513-3e00f1a.bottle.tar.gz"
      sha256 "96840e5657248fb68f006ff24f22997b4692bbaec2dc2b4737c4b457a1aad9eb"
    end
    on_intel do
