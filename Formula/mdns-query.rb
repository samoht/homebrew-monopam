class MdnsQuery < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/mdns-query-20260211.arm64_sonoma.bottle.tar.gz"
      sha256 "fd644fd5fe339d44332d7b5ad4a1c327d14edf001cb5e7bc4854876c8bb78ba7"
    end
    on_intel do
