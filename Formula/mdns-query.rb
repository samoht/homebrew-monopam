class MdnsQuery < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/mdns-query-20260415-1d4ee03.arm64_sonoma.bottle.tar.gz"
      sha256 "88ba55a571880cd62162e807ddb5b314fcf67eac61154c28329bcd59ec1f54a0"
    end
    on_intel do
