class MdnsQuery < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/mdns-query-20260207.arm64_sonoma.bottle.tar.gz"
      sha256 "8cd3f089bb6d528d0cbc41f6e2caf80f336ecdff9b4ba0fdcc7a4e349e917992"
    end
    on_intel do
