class MdnsQuery < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/mdns-query/arm64_sonoma/20260424-4aea2b3.bottle.tar.gz"
      sha256 "33cd85d0d5608d2a43aee6ec6ab2eeda1173490a9e47db10dbac3300295d412e"
    end
    on_intel do
