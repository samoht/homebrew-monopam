class Agent < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/agent-20260211.arm64_sonoma.bottle.tar.gz"
      sha256 "b713c8e47b19f48f2c4fdc31a5236fd00e3e9d566c3333d7c8389ab738b74529"
    end
    on_intel do
