class Agent < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/agent-20260204.arm64_sonoma.bottle.tar.gz"
      sha256 "532af035e6aa608bd95ab4345f76cc7981e780f04235b270a31ce8aa591f0a89"
    end
    on_intel do
