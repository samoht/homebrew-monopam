class Irmin < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/irmin-20260211.arm64_sonoma.bottle.tar.gz"
      sha256 "c4097f54a84cd6153ea9a5637db0f3eda410e1a24c566fb3475964e5b39f44dc"
    end
    on_intel do
