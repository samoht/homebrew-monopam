class Irmin < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/irmin-20260207.arm64_sonoma.bottle.tar.gz"
      sha256 "ce1d5e215f70ee01a81d1ad4fdf53f60e0c315e704478331187b73b0d783058f"
    end
    on_intel do
