class Irmin < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/irmin/arm64_sonoma/20260513-2fe05c6.bottle.tar.gz"
      sha256 "d1468cc005939cc2caf7e428348b766b7fc28d5388f226fd85d597bc0feaf1f8"
    end
    on_intel do
