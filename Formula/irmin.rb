class Irmin < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/irmin/arm64_sonoma/20260507-6919ee5.bottle.tar.gz"
      sha256 "3422b5a44aa692c987cfd4fc2f223a099f6f882969bbaa99551b4ecb3d1b5c10"
    end
    on_intel do
