class Crow < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/crow/arm64_sonoma/20260513-bdba8ba.bottle.tar.gz"
      sha256 "62dc57c11a011038349a31ecb5a80086bad616478331b5928e38affebdb07227"
    end
    on_intel do
