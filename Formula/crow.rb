class Crow < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/crow-20260319.arm64_sonoma.bottle.tar.gz"
      sha256 "653a0fcdf5cc0510cb14bb94d511501f5326d607b32a6512bbfcd9259bc0f2d5"
    end
    on_intel do
