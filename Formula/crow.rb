class Crow < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/crow-20260315.arm64_sonoma.bottle.tar.gz"
      sha256 "5bc765cc3f42b18a65f9bf167fb03f0cc8e9c4ed971da437f85e108d89395239"
    end
    on_intel do
