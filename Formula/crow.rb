class Crow < Formula
  ...
  on_macos do
    on_arm do
      url "https://homebrew-bottles.s3.fr-par.scw.cloud/crow-20260223.arm64_sonoma.bottle.tar.gz"
      sha256 "b7c3eedf414009b51e2bf866ba8e6fa03ea180740f0b61348fc71cddf80d3a0f"
    end
    on_intel do
